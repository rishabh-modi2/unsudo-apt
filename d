...
#
public_baseurl: https://chat.rishabh.ml/
...
#
#tls_certificate_path: "/data/chat.rishabh.ml.tls.crt"

# PEM-encoded private key for TLS
#
#tls_private_key_path: "/data/chat.rishabh.ml.tls.key"
...
#
log_config: "/data/chat.rishabh.ml.log.config"
...
#
registration_shared_secret: "H_m:AW4*;Y,ovv~5Z32nQ2S_l4*qUpuUSXbm=ey8J,*SVk9F3d"
...
#
macaroon_secret_key: "N^2d=L:B9oJ~&ipi#cBi=kYuGVcFTlog&8XoGD9wWfTtX2un;Y"

# a secret which is used to calculate HMACs for form values, to stop
# falsification of values. Must be specified for the User Consent
# forms to work.
#
form_secret: "5q@kPtkk^1bIDdrGc.+S@z;@06QBJq+mxT9vtmdH=Vd-dyliwC"

## Signing Keys ##

# Path to the signing key to sign messages with
#
signing_key_path: "/data/chat.rishabh.ml.signing.key"
