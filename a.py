...
a2 = "dank" or "Dank"
aa2 = "east or vest reddit is best."
...
a5 = " Ram" or "ram"
aa5 ="Hamare Sath Shri Raghunath To Kis Baat Ki Chinta hogi"
a6 =" modi"
...
a21 = " drugs "
aa21 = "drugs lekar aao saari pareshniyo ka ilaz pao"
a22 = "gf" or "GF" or "Gf" or "girlfriend" or "Girlfriend"
aa22 = "gf ek dhokha hai aur iss dhokhe se jitna door raha jaye utna sahi hai"
...
aa24 = "meko sex karna hai yaar koi sex karo be mujhe"
a25 = "pakistan" or "Pakistan"
aa25 = "pakistan ki maa ki chut"
a26 = "Gay" or "gay"
...
a35 = " bot "
aa35 = "Auto mod ki maa ki chut.....Sala jaha dekho vahi Bots nazar aate hai. aisa lagta hai insaano se jayada bot hai reddit par"
a36 = "navel"
...
def comment():
  ...
  try:
    for comment in reddit.subreddit('IndianDankMemes').stream.comments():
      ...
      if i > 105:
          if a1 in comment.body and comment.id not in comments_replied_to and comment.submission.id not in submission_id and comment.author != reddit.user.me() and comment.author != "AutoModerator" and comment.author != "QualityVote":
            sleep(s)
            comment.reply(aa1)
            #print(comment.id)
            #sleep(s)
